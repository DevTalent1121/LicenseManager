...
<div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="px-6">
                    <h1 class="inline-block text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight dark:text-slate-200 py-4 block sm:inline-block flex"><?php echo e(__('Create user')); ?></h1>
...
<?php endif; ?><?php /**PATH D:\My_Works\Laravel\LicenseManager\resources\views/admin/user/create.blade.php ENDPATH**/ ?>